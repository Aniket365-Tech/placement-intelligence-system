    ...
    <div className="space-y-6">
        ...
        <Card title="Skill Gap Summary" className="lg:col-span-2">
           <div className="space-y-4">
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <button className="text-xs text-blue-600 font-semibold flex items-center gap-1">View Heatmap <ArrowRight size={12} /></button>
              </div>
           </div>
        </Card>
        ...
        <Card title="Placement Probability" subtitle="Company: Google" className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none">
          <div className="flex flex-col items-center py-2">
            ...
            <div className="w-full h-1.5 bg-slate-700 rounded-full mb-6">
              <div className="h-full bg-blue-500 rounded-full w-[64%] shadow-[0_0_10px_rgba(59,130,246,0.5)]"></div>
            </div>
            <div className="grid grid-cols-2 gap-3 w-full">
              <div className="bg-slate-700/50 p-2 rounded-lg border border-slate-600/50 text-center">
                <p className="text-[10px] text-slate-400">Match</p>
                <p className="text-xs font-bold text-emerald-400">+82%</p>
              </div>
              <div className="bg-slate-700/50 p-2 rounded-lg border border-slate-600/50 text-center">
                <p className="text-[10px] text-slate-400">Comp.</p>
                <p className="text-xs font-bold text-rose-400">High</p>
              </div>
            </div>
          </div>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <Card title="Job Opportunities for You" action={<button className="text-blue-600 text-sm font-semibold">View All</button>}>
             <div className="space-y-3">
               {jobsList.map(job => (
                 <div key={job.id} className="flex items-center justify-between p-3 rounded-xl border border-slate-100 hover:border-blue-100 hover:bg-blue-50/30 transition-all cursor-pointer group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <Card title="Roadmap Progress" subtitle="Week 12 of 24">
             ...
             <Card title="AI Career Insight" className="bg-indigo-50 border-indigo-100">
        ...
        <div className="space-y-6">
          ...
          <Card title="Interview Prep Mode" className="overflow-hidden">
             ...
             <div className="space-y-2">
                ...
                <button className="w-full mt-2 py-2 text-xs font-bold border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors">Launch Practice Session</button>
             </div>
          </Card>
